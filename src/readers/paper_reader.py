...
if __name__ == "__main__":
    gemini_read_paper_content("/Users/hienht/Desktop/hienht/AI/contextual_rag/papers")
    # res = llama_parse_single_file(
    #     "/Users/hienht/Desktop/hienht/AI/contextual_rag/papers/2409.13588v1.pdf"
    # )
    # for r in res:
    #     print(r.text)
    #     print("-" * 100)
